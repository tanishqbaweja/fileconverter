...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "aiffId3SourcePatchSha256": "5cf4fdd13afd443cbd1fba8f44b130664b62cb6ced0e689bf9369ef25085deeb",
  ...
  "audioArtworkOptions": {"supportedOutputs": ["mp3", "flac", "aiff"], "supportedImageCodecs": ["mjpeg", "png"], "maximumImages": 1, "maximumBytes": 4194304, "maximumDimension": 4096, "maximumPixels": 16777216, "packetCopyWithoutImageDecode": true},
