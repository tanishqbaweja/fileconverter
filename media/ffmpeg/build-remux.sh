...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "modules": [
    {"name": "within-remux", "wasmPthreadPoolSize": 0, "videoCodecThreads": 1, "profiles": ["stream-copy", "audio", "aiff-audio", "h264-extract", "hevc-extract", "mpeg2-extract", "mpeg2-wrap", "mpegts-copy", "threegp-copy", "mov-copy", "flv-copy", "m4v-extract", "m4v-wrap", "av1-webm-copy", "matroska-copy", "mp3-extract", "aac-extract", "ogg-audio-extract"]},
  ...
  "enabledEncoders": ["alac", "flac", "h263", "libvpx_vp8", "libvpx_vp9", "mpeg4", "pcm_s16be", "pcm_s16le", "wmav2"],
  "enabledDemuxers": ["aac", "aiff", "amr", "asf", "avi", "flac", "flv", "h264", "m4v", "matroska", "mov", "mp3", "mpegts", "mpegvideo", "ogg", "wav"],
  "enabledMuxers": ["3gp", "adts", "aiff", "asf", "flac", "flv", "h264", "hevc", "ipod", "latm", "m4v", "matroska", "mov", "mp3", "mp4", "mpeg2video", "mpegts", "ogg", "wav", "webm"],
