...
cat > /out/build-manifest.json <<'JSON'
{
  ...
  "sequentialUnknownLengthUstarInput": true,
  "profiles": ["tar-to-sevenzip", "tar-gz-to-sevenzip", "tar-bz2-to-sevenzip", "tar-xz-to-sevenzip", "zip-to-sevenzip", "sevenzip-to-tar", "sevenzip-to-tar-gz", "sevenzip-to-tar-bz2", "sevenzip-to-tar-xz", "sevenzip-to-zip"]
}
JSON
