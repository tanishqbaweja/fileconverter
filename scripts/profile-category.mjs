...
const categories = {
  ...
  "avi-mpegts": {
    ...
    profiles: [
      ["avi-to-mpeg-ts", "fixtures/stress/media/mpeg4-mp3-webm-128m.avi"],
    ],
  },
  "container-threegp": {
    generator: "scripts/generate-container-mpegts-stress-fixtures.mjs",
  ...
  "avi-flv": {
    ...
    passSelectedFixturesToGenerator: true,
    profiles: [
      ["avi-to-flv", "fixtures/stress/media/h264-mp3-flv-128m.avi"],
    ],
  },
  "3gp": {
  ...
  "apng-output": {
    generator: "scripts/generate-image-fixtures.mjs",
    profiles: [
      ["gif-to-apng", "fixtures/images/animated-pattern.gif"],
