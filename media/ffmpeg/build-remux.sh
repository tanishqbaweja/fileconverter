...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "modules": [
    ...
    {"name": "within-webm", "wasmPthreadPoolSize": 8, "videoCodecThreads": 4, "profiles": ["mkv-to-webm", "mp4-to-webm", "mov-to-webm", "3gp-to-webm", "mpeg-ts-to-webm", "flv-to-webm", "ogv-to-webm", "m2v-to-webm"]},
    {"name": "within-vp9", "wasmPthreadPoolSize": 8, "videoCodecThreads": 4, "profiles": ["mkv-to-webm-vp9", "mp4-to-webm-vp9", "mov-to-webm-vp9", "3gp-to-webm-vp9", "mpeg-ts-to-webm-vp9", "flv-to-webm-vp9", "ogv-to-webm-vp9", "m2v-to-webm-vp9"]}
  ],
  "wasmSimd": true,
