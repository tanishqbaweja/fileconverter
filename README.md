...
without decoding pixels; the same ceiling reports classic-TIFF page-directory,
dimension, depth/color, compression, orientation, and bounded metadata facts;
SVG uses the bounded UTF-8 path. A ZIP package
