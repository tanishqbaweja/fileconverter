...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "enabledDemuxers": ["aiff", "avi", "flac", "flv", "matroska", "mov", "mp3", "mpegts", "mpegvideo", "ogg", "wav"],
