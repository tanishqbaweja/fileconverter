...
larger than 65,536 bytes and every destination write is awaited. Wasm memory is
fixed at 64 MiB. The route accepts regular files and directories using COPY,
