...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "videoEncoderOptions": {"selectableCodecs": ["vp8", "vp9", "mpeg4"], "selectableMaximumWidths": [320, 480, 640], "selectableBitRates": [300000, 600000, 1000000, 2000000, 4000000], "selectableFrameRateCaps": [15, 24, 25, 30], "selectableQualityPolicies": ["smaller", "balanced", "higher"], "zeroSelectsCertifiedAutomaticPolicy": true, "neverUpscales": true, "neverFrameRateUpconverts": true},
