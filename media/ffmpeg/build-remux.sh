...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "modules": [
    ...
    {"name": "within-webm", "wasmPthreadPoolSize": 8, "videoCodecThreads": 4, "profiles": ["mkv-to-webm", "mp4-to-webm", "mov-to-webm", "3gp-to-webm", "mpeg-ts-to-webm", "flv-to-webm", "avi-to-webm", "ogv-to-webm", "m2v-to-webm"]},
    {"name": "within-vp9", "wasmPthreadPoolSize": 8, "videoCodecThreads": 4, "profiles": ["mkv-to-webm-vp9", "mp4-to-webm-vp9", "mov-to-webm-vp9", "3gp-to-webm-vp9", "mpeg-ts-to-webm-vp9", "flv-to-webm-vp9", "avi-to-webm-vp9", "ogv-to-webm-vp9", "m2v-to-webm-vp9"]}
  ],
  "wasmSimd": true,
  ...
  "profiles": ["mkv-to-mp4", "mov-to-mp4", "3gp-to-mp4", "mpeg-ts-to-mp4", "flv-to-mp4", "avi-to-mp4", "mkv-to-m4a", "mov-to-m4a", "3gp-to-m4a", "mpeg-ts-to-m4a", "flv-to-m4a", "mp4-to-m4a", "aac-to-m4a", "mkv-to-wav", "mov-to-wav", "3gp-to-wav", "mpeg-ts-to-wav", "flv-to-wav", "avi-to-wav", "ogv-to-wav", "mp4-to-wav", "m4a-to-wav", "aac-to-wav", "amr-to-wav", "mp3-to-wav", "flac-to-wav", "wma-to-wav", "aiff-to-wav", "ogg-to-wav", "opus-to-wav", "mkv-to-flac", "mp4-to-flac", "mov-to-flac", "3gp-to-flac", "mpeg-ts-to-flac", "flv-to-flac", "avi-to-flac", "ogv-to-flac", "m4a-to-flac", "aac-to-flac", "amr-to-flac", "mp3-to-flac", "wav-to-flac", "wma-to-flac", "aiff-to-flac", "ogg-to-flac", "opus-to-flac", "wav-to-alac", "flac-to-alac", "wav-to-wma", "flac-to-wma", "mkv-to-mp4-mpeg4", "m2v-to-mp4-mpeg4", "mkv-to-webm", "mp4-to-webm", "mov-to-webm", "3gp-to-webm", "mpeg-ts-to-webm", "flv-to-webm", "avi-to-webm", "ogv-to-webm", "m2v-to-webm", "mkv-to-webm-vp9", "mp4-to-webm-vp9", "mov-to-webm-vp9", "3gp-to-webm-vp9", "mpeg-ts-to-webm-vp9", "flv-to-webm-vp9", "avi-to-webm-vp9", "ogv-to-webm-vp9", "m2v-to-webm-vp9"],
  ...
  "enabledDemuxers": ["aac", "aiff", "amr", "asf", "avi", "flac", "flv", "matroska", "mov", "mp3", "mpegts", "mpegvideo", "ogg", "wav"],
  "enabledMuxers": ["adts", "asf", "flac", "ipod", "latm", "mov", "mp4", "mpegts", "wav", "webm"],
