...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "modules": [
    {"name": "within-remux", "wasmPthreadPoolSize": 0, "videoCodecThreads": 1, "profiles": ["stream-copy", "audio", "h264-extract", "mpeg2-extract", "mpeg2-wrap", "m4v-extract", "m4v-wrap", "av1-webm-copy", "mp3-extract", "aac-extract"]},
  ...
  "enabledMuxers": ["adts", "asf", "flac", "h264", "ipod", "latm", "m4v", "mov", "mp3", "mp4", "mpeg2video", "mpegts", "wav", "webm"],
