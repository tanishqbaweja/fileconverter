...
- Public passed conversion profiles: **210**
- Public profiles with a retained successful Chrome stress report: **210**
- PDF profiles: **0** (intentionally prohibited)

## Latest full verification cycle

- **2026-08-09:** 469/469 production-browser tests passed; 19/19 unit tests passed; TypeScript, ESLint, and the production build passed.
...
- Video/container: additional elementary-stream codecs and raw outputs beyond H.264, MPEG-2, and MPEG-4 Part 2; broader OGV, 3GP, AVI, VP9, and AV1 container/codec combinations beyond the certified AV1 Matroska copy and Ogg-family audio-extraction routes, plus MPEG-2 audio combinations and additional codec conversions.
