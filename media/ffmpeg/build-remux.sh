...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "profiles": ["mkv-to-mp4", "mov-to-mp4", "mpeg-ts-to-mp4", "mkv-to-m4a", "mov-to-m4a", "mpeg-ts-to-m4a", "mp4-to-m4a", "mkv-to-wav", "mov-to-wav", "mpeg-ts-to-wav", "mp4-to-wav", "m4a-to-wav", "mp3-to-wav", "flac-to-wav", "aiff-to-wav", "ogg-to-wav", "opus-to-wav", "m4a-to-flac", "mp3-to-flac", "wav-to-flac", "mkv-to-mp4-mpeg4", "mkv-to-webm"],
  ...
  "enabledDemuxers": ["aiff", "flac", "matroska", "mov", "mp3", "mpegts", "ogg", "wav"],
  "enabledMuxers": ["adts", "flac", "latm", "mov", "mp4", "mpegts", "wav", "webm"],
  "enabledParsers": ["aac", "ac3", "flac", "h264", "hevc", "mpegaudio", "opus", "vorbis"],
