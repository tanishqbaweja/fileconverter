...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "enabledEncoders": ["alac", "flac", "h263", "libmp3lame", "libopencore_amrnb", "libvpx_vp8", "libvpx_vp9", "mpeg4", "pcm_s16be", "pcm_s16le", "wmav2"],
