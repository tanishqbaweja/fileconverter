...
emconfigure ./configure \
  ...
  --enable-muxer=flac,ipod,mp4,mov,mpegts,adts,wav,webm \
  --enable-decoder=aac,alac,flac,h264,hevc,mp3,mpeg2video,opus,pcm_s16be,pcm_s16le,theora,vorbis \
  --enable-encoder=alac,flac,pcm_s16le,mpeg4,libvpx_vp8 \
