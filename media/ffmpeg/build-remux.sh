...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "modules": [
    {"name": "within-remux", "wasmPthreadPoolSize": 0, "videoCodecThreads": 1, "profiles": ["stream-copy", "audio", "h264-extract"]},
  ...
  "enabledMuxers": ["adts", "asf", "flac", "h264", "ipod", "latm", "mov", "mp4", "mpegts", "wav", "webm"],
