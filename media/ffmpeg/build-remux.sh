...
sed -i 's/"ogg-to-opus",/"ogg-to-opus", "m4a-to-ogg", "aac-to-ogg", "amr-to-ogg", "mp3-to-ogg", "flac-to-ogg", "wav-to-ogg", "wma-to-ogg", "aiff-to-ogg", "opus-to-ogg",/' "${OUTPUT}/build-manifest.json"
...
sed -i 's/"flv-to-mov",/"flv-to-mov", "mkv-to-flv", "mp4-to-flv", "mov-to-flv", "3gp-to-flv", "mpeg-ts-to-flv",/' "${OUTPUT}/build-manifest.json"
