...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "modules": [
    {"name": "within-remux", "wasmPthreadPoolSize": 0, "videoCodecThreads": 1, "profiles": ["stream-copy", "audio", "h264-extract", "mpeg2-extract", "mpeg2-wrap"]},
  ...
  "enabledDemuxers": ["aac", "aiff", "amr", "asf", "avi", "flac", "flv", "h264", "matroska", "mov", "mp3", "mpegts", "mpegvideo", "ogg", "wav"],
  "enabledMuxers": ["adts", "asf", "flac", "h264", "ipod", "latm", "mov", "mp4", "mpeg2video", "mpegts", "wav", "webm"],
