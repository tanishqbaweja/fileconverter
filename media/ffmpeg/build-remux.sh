...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "licenses": ["FFmpeg LGPL-3.0-or-later", "libvpx BSD-3-Clause", "OpenCORE AMR Apache-2.0"],
  "initialWasmMemoryBytes": 33554432,
  "maximumWasmMemoryBytes": 100663296,
  "modules": [
    {"name": "within-remux", "wasmPthreadPoolSize": 0, "videoCodecThreads": 1, "profiles": ["stream-copy", "audio", "aiff-audio", "amr-audio", "h264-extract", "hevc-extract", "mpeg2-extract", "mpeg2-wrap", "mpegts-copy", "threegp-copy", "mov-copy", "flv-copy", "m4v-extract", "m4v-wrap", "av1-webm-copy", "matroska-copy", "mp3-extract", "aac-extract", "ogg-audio-extract"]},
  ...
  "enabledEncoders": ["alac", "flac", "h263", "libopencore_amrnb", "libvpx_vp8", "libvpx_vp9", "mpeg4", "pcm_s16be", "pcm_s16le", "wmav2"],
