...
cat > "${OUTPUT}/build-manifest.json" <<EOF
{
  ...
  "modules": [
    ...
    {"name": "within-webm", "wasmPthreadPoolSize": 8, "videoCodecThreads": 4, "profiles": ["mkv-to-webm", "mp4-to-webm", "mov-to-webm", "ogv-to-webm", "m2v-to-webm"]},
    {"name": "within-vp9", "wasmPthreadPoolSize": 8, "videoCodecThreads": 4, "profiles": ["mkv-to-webm-vp9", "mp4-to-webm-vp9", "mov-to-webm-vp9", "ogv-to-webm-vp9", "m2v-to-webm-vp9"]}
  ],
  "wasmSimd": true,
