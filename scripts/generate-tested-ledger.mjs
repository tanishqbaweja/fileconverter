...
const lines = [
  ...
  "",
  "- **2026-08-09:** 478/478 production-browser tests passed; 20/20 unit tests passed; TypeScript, ESLint, and the production build passed.",
...
lines.push(
  ...
  "",
  "- Video/container: additional elementary-stream codecs and raw outputs beyond H.264, MPEG-2, MPEG-4 Part 2, and the certified container-to-HEVC outputs; raw HEVC input wrapping remains unavailable because B-frame timing cannot be reconstructed losslessly without container timestamps. Broader OGV, 3GP, AVI, VP9, and AV1 container/codec combinations beyond the certified AV1 Matroska copy and Ogg-family audio-extraction routes, plus MPEG-2 audio combinations and additional codec conversions, also remain.",
