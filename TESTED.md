...
Updated 2026-08-09 from the capability registry and retained successful Chrome stress reports.
...
- Public passed conversion profiles: **205**
- Public profiles with a retained successful Chrome stress report: **205**
- PDF profiles: **0** (intentionally prohibited)

## Latest full verification cycle

- **2026-08-09:** 457/457 production-browser tests passed; 18/18 unit tests passed; TypeScript, ESLint, and the production build passed.
...
- Video/container: additional elementary-stream codecs and raw outputs beyond H.264, MPEG-2, and MPEG-4 Part 2; broader OGV, 3GP, AVI, VP9, and AV1 container/codec combinations beyond the certified AV1/Opus-or-Vorbis Matroska copy route, plus MPEG-2 audio combinations and additional codec conversions.
